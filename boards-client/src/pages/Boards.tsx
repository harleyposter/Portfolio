  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        {(selection === 0 || selection === 4) && <Objective projects={[UE2DCollisionTool(), STPC()]} title={'Objective 4'} desc={'Use software development processes to analyze a project problem and to design, build and test a corresponding software solution.'} status={'In Progress'}></Objective>}
